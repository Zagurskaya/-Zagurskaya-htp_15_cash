...
/**
 * The action is "Payment 2001".
 */
public class Payment20_01_Command implements Command {
    private String directoryPath;
    private static final Logger logger = LogManager.getLogger(Payment20_01_Command.class);
    ...
    public ActionType execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        } catch (ServiceException | NumberFormatException | CommandException e) {
