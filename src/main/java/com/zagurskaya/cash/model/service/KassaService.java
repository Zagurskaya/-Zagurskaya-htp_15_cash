...
public interface KassaService extends Service<Kassa> {
    ...
    boolean updateKassaOutSideOperation(Date date, Long id, Long currencyId, Double sum, Long sprOperationId) throws ServiceException, ServiceConstraintViolationException;
