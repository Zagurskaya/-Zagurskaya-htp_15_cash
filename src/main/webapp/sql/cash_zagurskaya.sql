...
USE `zagurskaya`;
CREATE TABLE IF NOT EXISTS `zagurskaya_epam`.`user`
(
    ...
    ENGINE = InnoDB;
-- -----------------------------------------------------
-- Data for table `zagurskaya_epam`.`user`
-- -----------------------------------------------------
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya_epam`.`user` (`id`, `login`, `password`, `fullname`, `role`)
...
CREATE TABLE IF NOT EXISTS `zagurskaya_epam`.`currency`
(
    `id`     INT          NOT NULL,
    `iso`    VARCHAR(45)  NULL,
...
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya_epam`.`currency` (`id`, `iso`, `nameRU`, `nameEN`)
...
CREATE TABLE IF NOT EXISTS `zagurskaya_epam`.`account`
(
    `id`          INT         NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_accaunt_currencys1`
        FOREIGN KEY (`currencyId`)
            REFERENCES `zagurskaya_epam`.`currency` (`id`)
            ON DELETE RESTRICT
            ON UPDATE RESTRICT
)
    ENGINE = InnoDB;
...
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya_epam`.`account` (`id`, `mask`, `subMask`, `currencyId`, `fullAccount`)
...
CREATE TABLE IF NOT EXISTS `zagurskaya_epam`.`rateNB`
(
    `id`         INT    NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_rateNB_currencys1`
        FOREIGN KEY (`currencyId`)
            ...
            ON DELETE RESTRICT
            ON UPDATE RESTRICT,
    CONSTRAINT RATENB_CONSTR UNIQUE (currencyId, date)
)
    ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS `zagurskaya_epam`.`rateCB`
(
    `id`        INT          NOT NULL AUTO_INCREMENT,
    `coming`    INT          NOT NULL,
...
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya_epam`.`rateNB` (`id`, `currencyId`, `date`, `sum`)
...
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya_epam`.`rateCB` (`id`, `coming`, `spending`, `timestamp`, `sum`, `isBack`)
...
CREATE TABLE IF NOT EXISTS `zagurskaya_epam`.`sprOperation`
(
    `id`            INT          NOT NULL,
    `nameRU`        VARCHAR(100) NULL,
    `nameEN`        VARCHAR(100) NULL,
...
CREATE TABLE IF NOT EXISTS `zagurskaya_epam`.`sprEntry`
(
    `id`             INT          NOT NULL,
    `name`           VARCHAR(100) NULL,
    `currencyId`     INT          NULL,
    `sprOperationId` INT          NOT NULL,
    `accountDebit`   VARCHAR(28)  NULL,
    `accountCredit`  VARCHAR(28)  NULL,
    `isSpending`     TINYINT(1)   NULL,
    `rate`           DOUBLE       NULL,
    PRIMARY KEY (`id`),
    INDEX `fk_sprEntry_sprOperation1_idx` (`sprOperationId` ASC),
    CONSTRAINT `fk_sprEntry_sprOperation1`
        FOREIGN KEY (`sprOperationId`)
            REFERENCES `zagurskaya_epam`.`sprOperation` (`id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
)
    ENGINE = InnoDB;
...
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya_epam`.`sprOperation` (`id`, `nameRU`, `nameEN`, `specification`)
...
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya_epam`.`sprEntry` (`id`, `name`, `currencyId`, `sprOperationId`, `accountDebit`, `accountCredit`,
                                     `isSpending`, `rate`)
...
CREATE TABLE IF NOT EXISTS `zagurskaya_epam`.`duties`
(
    `id`        INT          NOT NULL AUTO_INCREMENT,
    `userId`    INT          NOT NULL,
    `timestamp` TIMESTAMP(6) NULL,
    ...
    CONSTRAINT `fk_duties_user1`
        FOREIGN KEY (`userId`)
            REFERENCES `zagurskaya_epam`.`user` (`id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
)
    ENGINE = InnoDB;
...
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya_epam`.`duties` (`id`, `userId`, `timestamp`, `number`, `isClose`)
...
CREATE TABLE IF NOT EXISTS `zagurskaya_epam`.`userOperation`
(
    `id`              INT          NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_userOperation_duties1`
        FOREIGN KEY (`dutiesId`)
            REFERENCES `zagurskaya_epam`.`duties` (`id`)
            ON DELETE RESTRICT
            ON UPDATE RESTRICT
)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `zagurskaya_epam`.`kassa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zagurskaya_epam`.`kassa`
(
    `id`          INT    NOT NULL AUTO_INCREMENT,
    `currencyId`  INT    NULL,
...
-- -----------------------------------------------------
-- Table `zagurskaya_epam`.`userEntry`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zagurskaya_epam`.`userEntry`
(
    `id`              INT         NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_usersEntry_userOperation1`
        FOREIGN KEY (`userOperationId`)
            REFERENCES `zagurskaya_epam`.`userOperation` (`id`)
            ON DELETE RESTRICT
            ON UPDATE RESTRICT
)
    ENGINE = InnoDB;
...
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya_epam`.`userOperation` (`id`, `timestamp`, `rate`, `sum`, `currencyId`, `userId`, `dutiesId`,
                                          `operationId`, `specification`, `checkingAccount`, `fullName`)
VALUES (DEFAULT, '2020-02-01 11:12:13', 2.1, 1000, 840, 2, 1, 1000, 'Получены денежные средства', NULL, NULL);
INSERT INTO `zagurskaya_epam`.`userOperation` (`id`, `timestamp`, `rate`, `sum`, `currencyId`, `userId`, `dutiesId`,
                                          `operationId`, `specification`, `checkingAccount`, `fullName`)
VALUES (DEFAULT, '2020-02-01 11:13:13', 2.1, 100, 840, 2, 1, 10, 'В личное пользование', NULL, NULL);
INSERT INTO `zagurskaya_epam`.`userOperation` (`id`, `timestamp`, `rate`, `sum`, `currencyId`, `userId`, `dutiesId`,
                                          `operationId`, `specification`, `checkingAccount`, `fullName`)
VALUES (DEFAULT, '2020-02-01 11:14:13', 1, 56, 933, 2, 1, 998, 'За питание в СД№3', '3012000000005', NULL);
INSERT INTO `zagurskaya_epam`.`userOperation` (`id`, `timestamp`, `rate`, `sum`, `currencyId`, `userId`, `dutiesId`,
                                          `operationId`, `specification`, `checkingAccount`, `fullName`)
VALUES (DEFAULT, '2020-02-01 11:15:13', 2.1, 1000, 840, 3, 2, 1000, 'Получены денежные средства', NULL, NULL);
INSERT INTO `zagurskaya_epam`.`userOperation` (`id`, `timestamp`, `rate`, `sum`, `currencyId`, `userId`, `dutiesId`,
                                          `operationId`, `specification`, `checkingAccount`, `fullName`)
VALUES (DEFAULT, '2020-02-01 11:16:13', 2.15, 200, 840, 3, 2, 20, 'В личное пользование', NULL, NULL);
INSERT INTO `zagurskaya_epam`.`userOperation` (`id`, `timestamp`, `rate`, `sum`, `currencyId`, `userId`, `dutiesId`,
                                          `operationId`, `specification`, `checkingAccount`, `fullName`)
VALUES (DEFAULT, '2020-02-01 11:17:13', 1, 20, 933, 3, 2, 998, 'За мобильный телефор', '3012000000023', NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `zagurskaya_epam`.`kassa`
-- -----------------------------------------------------
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya_epam`.`kassa` (`id`, `currencyId`, `received`, `coming`, `spending`, `transmitted`, `balance`,
                                  `userId`, `date`, `dutiesId`)
VALUES (DEFAULT, 643, 0, 0, 0, 0, 0, 2, '2020-02-01', 1);
INSERT INTO `zagurskaya_epam`.`kassa` (`id`, `currencyId`, `received`, `coming`, `spending`, `transmitted`, `balance`,
                                  `userId`, `date`, `dutiesId`)
VALUES (DEFAULT, 840, 1000, 100, 0, 0, 1100, 2, '2020-02-01', 1);
INSERT INTO `zagurskaya_epam`.`kassa` (`id`, `currencyId`, `received`, `coming`, `spending`, `transmitted`, `balance`,
                                  `userId`, `date`, `dutiesId`)
VALUES (DEFAULT, 978, 0, 0, 0, 0, 0, 2, '2020-02-01', 1);
INSERT INTO `zagurskaya_epam`.`kassa` (`id`, `currencyId`, `received`, `coming`, `spending`, `transmitted`, `balance`,
                                  `userId`, `date`, `dutiesId`)
VALUES (DEFAULT, 933, 1000, 100, 210, 0, 690, 2, '2020-02-01', 1);
INSERT INTO `zagurskaya_epam`.`kassa` (`id`, `currencyId`, `received`, `coming`, `spending`, `transmitted`, `balance`,
                                  `userId`, `date`, `dutiesId`)
VALUES (DEFAULT, 643, 0, 0, 0, 0, 0, 3, '2020-02-01', 2);
INSERT INTO `zagurskaya_epam`.`kassa` (`id`, `currencyId`, `received`, `coming`, `spending`, `transmitted`, `balance`,
                                  `userId`, `date`, `dutiesId`)
VALUES (DEFAULT, 840, 1000, 0, 200, 0, 800, 3, '2020-02-01', 2);
INSERT INTO `zagurskaya_epam`.`kassa` (`id`, `currencyId`, `received`, `coming`, `spending`, `transmitted`, `balance`,
                                  `userId`, `date`, `dutiesId`)
VALUES (DEFAULT, 978, 0, 0, 0, 0, 0, 3, '2020-02-01', 2);
INSERT INTO `zagurskaya_epam`.`kassa` (`id`, `currencyId`, `received`, `coming`, `spending`, `transmitted`, `balance`,
                                  `userId`, `date`, `dutiesId`)
VALUES (DEFAULT, 933, 1000, 450, 0, 0, 1450, 3, '2020-02-01', 2);

COMMIT;


-- -----------------------------------------------------
-- Data for table `zagurskaya_epam`.`userEntry`
-- -----------------------------------------------------
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya_epam`.`userEntry` (`id`, `userOperationId`, `sprEntryId`, `currencyId`, `accountDebit`,
                                      `accountCredit`, `sum`, `isSpending`, `rate`)
VALUES (DEFAULT, 1, 100001, 840, NULL, '1010000000840', 1000, 0, 2.1);
INSERT INTO `zagurskaya_epam`.`userEntry` (`id`, `userOperationId`, `sprEntryId`, `currencyId`, `accountDebit`,
                                      `accountCredit`, `sum`, `isSpending`, `rate`)
VALUES (DEFAULT, 1, 100004, 933, NULL, '1010000000933', 1000, 0, 1);
INSERT INTO `zagurskaya_epam`.`userEntry` (`id`, `userOperationId`, `sprEntryId`, `currencyId`, `accountDebit`,
                                      `accountCredit`, `sum`, `isSpending`, `rate`)
VALUES (DEFAULT, 2, 1001, 840, '1010000000840', '6901000000840', 100, 0, 2.1);
INSERT INTO `zagurskaya_epam`.`userEntry` (`id`, `userOperationId`, `sprEntryId`, `currencyId`, `accountDebit`,
                                      `accountCredit`, `sum`, `isSpending`, `rate`)
VALUES (DEFAULT, 2, 1002, 933, '6911000000840', '1010000000933', 210, 1, 1);
INSERT INTO `zagurskaya_epam`.`userEntry` (`id`, `userOperationId`, `sprEntryId`, `currencyId`, `accountDebit`,
                                      `accountCredit`, `sum`, `isSpending`, `rate`)
VALUES (DEFAULT, 3, 99801, 933, '1010000000933', '3819000000000', 56, 0, 1);
INSERT INTO `zagurskaya_epam`.`userEntry` (`id`, `userOperationId`, `sprEntryId`, `currencyId`, `accountDebit`,
                                      `accountCredit`, `sum`, `isSpending`, `rate`)
VALUES (DEFAULT, 4, 10001, 840, '', '1010000000840', 1000, 0, 2.1);
INSERT INTO `zagurskaya_epam`.`userEntry` (`id`, `userOperationId`, `sprEntryId`, `currencyId`, `accountDebit`,
                                      `accountCredit`, `sum`, `isSpending`, `rate`)
VALUES (DEFAULT, 4, 10004, 933, NULL, '1010000000933', 1000, 0, 2.1);
INSERT INTO `zagurskaya_epam`.`userEntry` (`id`, `userOperationId`, `sprEntryId`, `currencyId`, `accountDebit`,
                                      `accountCredit`, `sum`, `isSpending`, `rate`)
VALUES (DEFAULT, 5, 2001, 840, '6901000000840', '1010000000840', 200, 1, 2.15);
INSERT INTO `zagurskaya_epam`.`userEntry` (`id`, `userOperationId`, `sprEntryId`, `currencyId`, `accountDebit`,
                                      `accountCredit`, `sum`, `isSpending`, `rate`)
VALUES (DEFAULT, 5, 2001, 933, '1010000000840', '6911000000840', 430, 0, 1);
INSERT INTO `zagurskaya_epam`.`userEntry` (`id`, `userOperationId`, `sprEntryId`, `currencyId`, `accountDebit`,
                                      `accountCredit`, `sum`, `isSpending`, `rate`)
VALUES (DEFAULT, 6, 99801, 933, '1010000000933', '3819000000000', 20, 0, 1);
