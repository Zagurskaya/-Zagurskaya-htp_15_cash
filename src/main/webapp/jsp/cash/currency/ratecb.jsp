...
<div class="container">
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <c:forEach items="${rateCB}" var="rateCB">
            <tr>
                ...
                <td><c:out value="${rateCB.timestamp}"/></td>
    ...
    <div align="center" style="text-align: center">
        <c:if test="${currentPage != 1}">
            <a href="do?command=RateCB&page=${currentPage - 1}"><fmt:message key="tabulation.previous"/></a>
        </c:if>
        ...
        <c:forEach begin="1" end="${numberOfPages}" var="i">
            <c:choose>
                ...
                <c:otherwise>
                    <a href="do?command=RateCB&page=${i}">${i}</a>
                </c:otherwise>
            </c:choose>
        </c:forEach>
        ...
        <c:if test="${currentPage lt numberOfPages}">
            <a href="do?command=RateCB&page=${currentPage + 1}"><fmt:message key="tabulation.next"/></a>
        </c:if>
    </div>
</div>
</body>
