...
<div class="container">
    ...
    <form class="form-horizontal" actionType="do?command=Payment20_02" method="post">
        <fieldset>
            <br>
            <div class="row">
                <div class=col-md-3><fmt:message key="page.payment20.label.receive"/></div>
                <div class=col-md-2><fmt:message key="page.payment20.label.sum"/></div>
                <div class=col-md-2><fmt:message key="page.payment20.label.rate"/></div>
            </div>
            ...
            <br>
            <div class="row">
                <div class=col-md-3><fmt:message key="page.payment20.label.come"/></div>
                <div class=col-md-2><fmt:message key="page.payment20.label.sum"/>е</div>
            </div>
            <c:forEach items="${currencies}" var="currency">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <button id="paymentButton" name="paymentButton" class="btn btn-primary">
                        <fmt:message key="page.payment20.button.enter"/></button>
                </div>
            </div>
        </fieldset>
    </form>
